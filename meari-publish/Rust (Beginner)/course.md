...
later chapters deliberately reuse the vocabulary and mental models introduced
earlier. Python comparisons are optional side notes; you never need Python to
understand the Rust explanation. **Optional: Deeper Memory** is enrichment, not
a requirement for being productive in beginner Rust.
